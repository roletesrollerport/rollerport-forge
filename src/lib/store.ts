import type {
  ...
  Cliente, Orcamento, Pedido, OrdemServico, ItemEstoque, Usuario
} from './types';
...
const SEED_TUBOS: Tubo[] = [
  { id: '1', diametro: 50, parede: 3, valorKg: 7.40, valorMetro: 27.02 },
  { id: '2', diametro: 50, parede: 3.75, valorKg: 3.00, valorMetro: 13.47 },
  { id: '3', diametro: 60, parede: 3, valorKg: 3.00, valorMetro: 13.28 },
  { id: '4', diametro: 60, parede: 5, valorKg: 3.00, valorMetro: 21.36 },
  { id: '5', diametro: 63, parede: 3, valorKg: 3.00, valorMetro: 13.98 },
  { id: '6', diametro: 76, parede: 3, valorKg: 6.70, valorMetro: 37.99 },
  { id: '7', diametro: 102, parede: 2.25, valorKg: 5.70, valorMetro: 33.12 },
  { id: '8', diametro: 102, parede: 2.65, valorKg: 5.70, valorMetro: 38.86 },
  { id: '9', diametro: 102, parede: 3.75, valorKg: 6.00, valorMetro: 57.24 },
  { id: '10', diametro: 115, parede: 3, valorKg: 3.00, valorMetro: 26.10 },
  { id: '11', diametro: 127, parede: 3, valorKg: 6.70, valorMetro: 64.54 },
  { id: '12', diametro: 140, parede: 3.35, valorKg: 3.10, valorMetro: 36.75 },
  { id: '13', diametro: 152, parede: 3, valorKg: 3.10, valorMetro: 35.88 },
  { id: '14', diametro: 165, parede: 3.75, valorKg: 3.10, valorMetro: 48.54 },
];

const SEED_EIXOS: Eixo[] = [
  { id: '1', diametro: '15', valorKg: 9.66, valorMetro: 14.06 },
  { id: '2', diametro: '17', valorKg: 9.66, valorMetro: 18.06 },
  { id: '3', diametro: '20', valorKg: 9.66, valorMetro: 24.99 },
  { id: '4', diametro: '25', valorKg: 9.66, valorMetro: 39.05 },
  { id: '5', diametro: '30', valorKg: 9.66, valorMetro: 56.23 },
  { id: '6', diametro: '35', valorKg: 9.66, valorMetro: 76.54 },
  { id: '7', diametro: '40', valorKg: 9.66, valorMetro: 99.97 },
  { id: '8', diametro: '45', valorKg: 3.20, valorMetro: 41.91 },
  { id: '9', diametro: '50', valorKg: 3.20, valorMetro: 51.74 },
  { id: '10', diametro: '20-INOX', valorKg: 3.20, valorMetro: 17.00 },
];
...
const SEED_CLIENTES: Cliente[] = [
  { id: '1', nome: 'Polimix', cnpj: '12.345.678/0001-90', email: 'contato@polimix.com.br', telefone: '(11) 3456-7890', endereco: 'Rua Industrial, 500', cidade: 'São Paulo', estado: 'SP', contato: 'João Silva', createdAt: '2025-01-15' },
  { id: '2', nome: 'Votorantim Cimentos', cnpj: '22.333.444/0001-55', email: 'compras@votorantim.com', telefone: '(11) 2345-6789', endereco: 'Av. Paulista, 1000', cidade: 'São Paulo', estado: 'SP', contato: 'Maria Souza', createdAt: '2025-02-01' },
];
