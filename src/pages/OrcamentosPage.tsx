      ...
      <div>
        <div className="flex gap-2 mb-4 print:hidden overflow-x-auto pb-1 mobile-btn-scroll">
          ...
          <Button variant="outline" onClick={() => {
            const emp = EMPRESAS[viewOrc.empresaEmitente || 'rollerport'];
            const msg = encodeURIComponent(`Olá!\n\nSegue o Orçamento Nº ${viewOrc.numero} - ${emp.nome}\n\nCliente: ${viewOrc.clienteNome}\nValor Total: ${fmt(viewOrc.valorTotal)}\n\nAtenciosamente,\n${emp.nome}`);
